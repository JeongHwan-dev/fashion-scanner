        ...
        {!blackpink ? (
          <>
            <div className="questions__question">
              ...
              <p>
                패션업계에서 유명한 케이팝 스타를 선정한 후 AI 이미지 처리 기능을 활용해 '착용한
            ...
            <div className="questions__question">
              ...
              <p>
                패션 스캐너는 공정한 과정을 거쳐 케이팝 스타를 선정합니다. 선정 기준의 경우 외부
                공개가 어려운 점 양해 부탁드립니다.
              </p>
            </div>
            <div className="questions__question">
              <p>Q. 사진을 보냈는데 이메일 알림을 못 받았습니다.</p>
              <p>
            ...
            <div className="questions__question">
              ...
              <p>
                패션 스캐너는 판매 링크를 연결해 드릴뿐 물품의 재고, 배송, 품질 관련해서는 각
                판매처에 문의 부탁드립니다.
              </p>
            </div>
            <div className="questions__question">
              <p>Q. 패션 스캐너의 다음 케이팝 스타를 추천하고 싶습니다.</p>
              <p>
          ...
          <>
            ...
            <div className="questions__question">
              ...
              <p>
                메인 페이지 하단 '패션 스캐너를 즐기는 또 다른 방법'을 통해 사진을 보내주시면 내부
                검토를 거쳐 이메일 알림을 드립니다.
              </p>
            </div>
            <div className="questions__question">
              ...
              <p>
                현재 파일 형식은 jpg, jpeg, png만 지원하고 있습니다. 첨부하신 이미지 파일의 형식을
                다시 한번 확인해 주세요.
              </p>
            </div>
          </>
