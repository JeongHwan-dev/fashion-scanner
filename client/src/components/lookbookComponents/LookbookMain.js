            ...
            <div className="lookbookmain__infoinner">
              ...
              <div className="lookbookmain__recomm">
                <div className="lookbookmain__recomminner">
                  <img alt="recommend image1"/>
                  <img alt="recommend image2"/>
                  <img alt="recommend image3"/>   
                  {/* 이미지 두개 더 들어감 */}
                </div>
              </div>
            </div>
    ...
    <>
      <section className="lookbookmain">
        <div className="lookbookmain__inner">
          <Swiper className="lookbookmain_swiper1" navigation pagination spaceBetween={0} slidesPerView={1}>
            {slides}
          </Swiper>
          <Swiper>{/* 썸네일 들어갈 곳 */}</Swiper>
        </div>
      </section>
    </>
  );
